    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="h-9 w-9 rounded-full bg-background/50 hover:bg-accent hover:text-accent-foreground backdrop-blur-sm shadow-sm transition-all focus-visible:ring-0 focus-visible:ring-offset-0">
